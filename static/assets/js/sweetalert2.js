...
!function (e, t) {
    ...
    const he = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], ge = e => {
        if (!e.input) return;
    ...
    const mt = e => {
        ...
        }, ht = e => void 0 === e ? {isConfirmed: !1, isDenied: !1, isDismissed: !0} : Object.assign({
            isConfirmed: !1,
            isDenied: !1,
            isDismissed: !1
        }, e), gt = (e, t, n) => {
    ...
    const Ut = {
        ...
        Jt = e => {
            ...
            !1 === e.backdrop && e.allowOutsideClick && u('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), e.theme && !["light", "dark", "auto"].includes(e.theme) && u(`Invalid theme "${e.theme}". Expected "light", "dark", or "auto"`);
    ...
    const vn = {};
    const wn = e => {
        for (let t = e.target; t && t !== document; t = t.parentNode) for (const e in vn) {
    ...
    const En = ["swal-title", "swal-html", "swal-footer"], kn = e => {
        const t = {};
